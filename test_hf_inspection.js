const { analyzeImageWithHuggingFace } = require('./server/services/huggingfaceImageService');
const fs = require('fs');
...
async function testInspection() {
  ...
  // Test 1: Test with dummy landslide base64 image (small solid brown/green canvas)
